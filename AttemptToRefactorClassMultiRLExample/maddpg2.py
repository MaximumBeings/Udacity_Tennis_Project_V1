...
class MADDPG:
    def __init__(self, discount_factor=0.95, tau=0.02):
        ...
        """
        self.maddpg_agent = [DDPGAgent(24, 32, 16, 2, 28, 32, 16), 
                             DDPGAgent(24, 32, 16, 2, 28, 32, 16)]
    ...
    def update(self, samples, agent_number, logger):
        ...
        target_critic_input = torch.cat((next_obs_full.squeeze(dim=2).t(),target_actions), dim=1).to(device)
